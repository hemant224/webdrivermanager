...
For further information about advanced capabilities in Docker (e.g., volumes, use of shared memory, screen resolution, and more), read the [documentation][WebDriverManager].
